...
const BookCard = ({ item }) => {
    ...
    return (
        <Link to={`/exchange/books/${item?._id}`} className=' w-full lg:w-96 flex flex-col justify-center  items-center content-center gap-3 shadow-md rounded-md border-2 h-auto hover:shadow-2xl pb-5'>
