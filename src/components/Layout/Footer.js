...
const Footer = () => {
    return (
        <>
            <footer className="footer p-10 bg-primary px-12 flex justify-between items-center font-bold text-white mt-40">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-primary text-white border-gray-700">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Book Sharing. <br />Providing reliable tech since 2023</p>
                </aside>
